		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "vishnudemo2",
									"targetURL": "#vishnuproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vishnuproject2-display": {
								"semanticObject": "vishnuproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vishnuproject2",
									"url": sap.ui.require.toUrl("vishnuproject2")
								}
							}
						}
					}
